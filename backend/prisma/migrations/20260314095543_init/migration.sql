...
CREATE TABLE "User" (
    ...
    "avatarUrl" TEXT,
    "avatarColor" TEXT NOT NULL DEFAULT '#94a3b8',
...
-- CreateIndex
CREATE UNIQUE INDEX "Reaction_userId_chatMessageId_emoji_key" ON "Reaction"("userId", "chatMessageId", "emoji");
...
-- AddForeignKey
ALTER TABLE "Reaction" ADD CONSTRAINT "Reaction_chatMessageId_fkey" FOREIGN KEY ("chatMessageId") REFERENCES "ChatMessage"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
